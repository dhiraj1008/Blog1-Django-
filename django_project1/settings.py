...
SECRET_KEY = 'django-insecure-p%f_#(jvt8c#)zie9cwt&s91ce4a3)w053#wltx4ub4%!fi@nh'
...
# for security purpose we are hidding the credientials into the environment variables.
...
# we wont want user to upload the file with same name which is already in our s3 
